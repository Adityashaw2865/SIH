...
export default function Login() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // FIXED BUG: admin accounts were falling into the "else" branch and
      // being sent to /doctor/dashboard, which has no Manage tab (staff
      // creation, analytics, users overview). TriageDashboard.jsx already
      // treats role === "admin" as a first-class case, and Shells.jsx's
      // nav config confirms admins are meant to share the Triage
      // Dashboard — route them there instead.
